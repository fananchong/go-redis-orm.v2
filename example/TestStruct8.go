...
type TestStruct8 struct {
	Key    int32
	values map[int32]*TestStruct8Item
...
func NewTestStruct8(dbName string, key int32) *TestStruct8 {
	return &TestStruct8{
		Key:         key,
		values:      make(map[int32]*TestStruct8Item),
		__dbName:    dbName,
		__dbKey:     "TestStruct8:" + fmt.Sprintf("%d", key),
		__dirtyData: make(map[int32]int),
	}
}

// 若访问数据库失败返回-1；若 key 存在返回 1 ，否则返回 0 。
func (this *TestStruct8) HasKey() (int, error) {
...
func (this *TestStruct8) Load() error {
	...
	for i := 0; i < len(val); i += 2 {
		...
		item := NewTestStruct8Item(subKey, this)
...
func (this *TestStruct8) Save() error {
...
func (this *TestStruct8) Delete() error {
	db := go_redis_orm.GetDB(this.__dbName)
...
func (this *TestStruct8) NewItem(subKey int32) *TestStruct8Item {
	item := NewTestStruct8Item(subKey, this)
	this.values[subKey] = item
...
func (this *TestStruct8) DeleteItem(subKey int32) error {
...
func (this *TestStruct8) GetItem(subKey int32) *TestStruct8Item {
...
func (this *TestStruct8) GetItems() []*TestStruct8Item {
	var ret []*TestStruct8Item
...
func (this *TestStruct8) DirtyData() (map[int32][]byte, error) {
...
func (this *TestStruct8) Save2(dirtyData map[int32][]byte) error {
	if len(dirtyData) == 0 {
		return nil
	}
	db := go_redis_orm.GetDB(this.__dbName)
...
func (this *TestStruct8) IsLoad() bool {
	return this.__isLoad
}

func (this *TestStruct8) Expire(v uint) {
	this.__expire = v
}
