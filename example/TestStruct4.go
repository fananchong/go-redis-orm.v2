...
type TestStruct4 struct {
	Key    int32
	values map[int32]*TestStruct4Item
...
func NewTestStruct4(dbName string, key int32) *TestStruct4 {
	return &TestStruct4{
		Key:         key,
		values:      make(map[int32]*TestStruct4Item),
		__dbName:    dbName,
		__dbKey:     "TestStruct4:" + fmt.Sprintf("%d", key),
		__dirtyData: make(map[int32]int),
	}
}

// 若访问数据库失败返回-1；若 key 存在返回 1 ，否则返回 0 。
func (this *TestStruct4) HasKey() (int, error) {
...
func (this *TestStruct4) Load() error {
	...
	for i := 0; i < len(val); i += 2 {
		...
		item := NewTestStruct4Item(subKey, this)
...
func (this *TestStruct4) Save() error {
...
func (this *TestStruct4) Delete() error {
	db := go_redis_orm.GetDB(this.__dbName)
...
func (this *TestStruct4) NewItem(subKey int32) *TestStruct4Item {
	item := NewTestStruct4Item(subKey, this)
	this.values[subKey] = item
...
func (this *TestStruct4) DeleteItem(subKey int32) error {
...
func (this *TestStruct4) GetItem(subKey int32) *TestStruct4Item {
...
func (this *TestStruct4) GetItems() []*TestStruct4Item {
	var ret []*TestStruct4Item
...
func (this *TestStruct4) DirtyData() (map[int32][]byte, error) {
...
func (this *TestStruct4) Save2(dirtyData map[int32][]byte) error {
	if len(dirtyData) == 0 {
		return nil
	}
	db := go_redis_orm.GetDB(this.__dbName)
...
func (this *TestStruct4) IsLoad() bool {
	return this.__isLoad
}

func (this *TestStruct4) Expire(v uint) {
	this.__expire = v
}
