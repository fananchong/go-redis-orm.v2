...
type TestStruct6 struct {
	Key    int32
	values map[int32]*TestStruct6Item
...
func NewTestStruct6(dbName string, key int32) *TestStruct6 {
	return &TestStruct6{
		Key:         key,
		values:      make(map[int32]*TestStruct6Item),
		__dbName:    dbName,
		__dbKey:     "TestStruct6:" + fmt.Sprintf("%d", key),
		__dirtyData: make(map[int32]int),
	}
}

// 若访问数据库失败返回-1；若 key 存在返回 1 ，否则返回 0 。
func (this *TestStruct6) HasKey() (int, error) {
...
func (this *TestStruct6) Load() error {
	...
	for i := 0; i < len(val); i += 2 {
		...
		item := NewTestStruct6Item(subKey, this)
...
func (this *TestStruct6) Save() error {
...
func (this *TestStruct6) Delete() error {
	db := go_redis_orm.GetDB(this.__dbName)
...
func (this *TestStruct6) NewItem(subKey int32) *TestStruct6Item {
	item := NewTestStruct6Item(subKey, this)
	this.values[subKey] = item
...
func (this *TestStruct6) DeleteItem(subKey int32) error {
...
func (this *TestStruct6) GetItem(subKey int32) *TestStruct6Item {
...
func (this *TestStruct6) GetItems() []*TestStruct6Item {
	var ret []*TestStruct6Item
...
func (this *TestStruct6) DirtyData() (map[int32][]byte, error) {
...
func (this *TestStruct6) Save2(dirtyData map[int32][]byte) error {
	if len(dirtyData) == 0 {
		return nil
	}
	db := go_redis_orm.GetDB(this.__dbName)
...
func (this *TestStruct6) IsLoad() bool {
	return this.__isLoad
}

func (this *TestStruct6) Expire(v uint) {
	this.__expire = v
}
